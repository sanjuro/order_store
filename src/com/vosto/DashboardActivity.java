 ...
 */
public class DashboardActivity extends VostoBaseActivity implements OnRestReturn, OnItemClickListener, OnDismissListener, OnClickListener {
    ...
    public void onRestReturn(RestResult result) {
        ...
        if(result instanceof GetNewOrdersResult){
            ...
            for (int i = 0; i < this.newOrders.length; i++) {
                ...
                moveOrder.setOnClickListener(new OnClickListener() {
                    @Override
    ...
    public void moveToProgress(View v) {
        d = new Dialog(this);
        d.requestWindowFeature(Window.FEATURE_NO_TITLE);
        d.setContentView(R.layout.in_progress_dialog);
        d.show();
    }
